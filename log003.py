...
# Nope
# with open("topics.csv", "w+", encoding="UTF8") as csvfile:
#    writer = csv.writer(csvfile)
#    for topic in topics_raw:
#        writer.writerow(topic)
#
pandasdict = {"name": [topic["name"]], "url": [topic["url"]]}

pandasdataframe = pandas.DataFrame([pandasdict])

pandasdataframe.to_csv("topics.csv")
